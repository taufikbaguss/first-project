...
<head>
  <meta charset="utf-8">
  <title>rentalfilm.bloounded.com</title>
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="intro-title mb-4">I am Bagus Wicaksono</h1>
          <p class="intro-subtitle"><span class="text-slider-items">Web Developer,Web Designer,Graphic Designer,Semuanye Dahh
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 col-md-7">
                    <div class="about-info">
                      <p><span class="title-s">Name: </span> <span>Bagus Taufik Wicaksono</span></p>
            ...
            <div class="card-footer">
              <div class="post-author">
                <a href="#">
                  ...
                  <span class="author">Bagus Taufik Wicaksono</span>
                </a>
              </div>
              <div class="post-date">
          ...
          <div class="card card-blog">
            ...
            <div class="card-footer">
              <div class="post-author">
                <a href="#">
                  <img src="img/testimonial-2.jpg" alt="" class="avatar rounded-circle">
                  <span class="author">Bagus Wicaksono</span>
                </a>
              </div>
              <div class="post-date">
                <span class="ion-ios-clock-outline"></span> 10 min
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="copyright-box">
              <p class="copyright">&copy; Copyright <strong>bloounded</strong>. All Rights Reserved</p>
              <div class="credits">
                <!--
